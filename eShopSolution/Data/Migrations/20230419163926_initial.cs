        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplyForAll = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    DiscountPercent = table.Column<int>(type: "int", nullable: true),
                    DiscountAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ProductIds = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    ProductCategoryIds = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false, defaultValue: 1)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("f2994bad-dd70-486f-9345-02cac10a5466"), 0, new DateTime(2023, 4, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "94fae2f8-40d7-4402-93a7-2667d9fbccde", "admin@gmail.com", true, "Hai", "Nguyen", false, null, "admin@gmail.com", "admin", "AQAAAAEAACcQAAAAENPukDMMKZ7Z356VTKGhB1yajbcza1qPVev/hPtyfAO8CL0WvTpx8A4oTU/KdLxFtg==", null, false, "", false, "admin" });

            migrationBuilder.InsertData(
                table: "AppUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { new Guid("9b6fc39c-753f-460e-99a6-99bbd80ee262"), new Guid("f2994bad-dd70-486f-9345-02cac10a5466") });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "IsShowinHome", "Name", "ParentId", "SeoAlias", "SeoDescription", "SeoTitle", "SortOrder", "Status" },
                values: new object[,]
                {
                    { 1, true, "Áo Nam", null, "ao-nam", "Sản Phẩm Áo Thời Trang Nam", "Sản Phẩm Áo Thời Trang Nam", 1, 1 },
                    { 2, true, "Áo Nữ", null, "ao-nu", "Sản Phẩm Áo Thời Trang Nữ", "Sản Phẩm Áo Thời Trang Nữ", 2, 1 }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "DateCreate", "Description", "Details", "Name", "OriginalPrice", "Price", "SeoAlias", "SeoDescription", "SeoTitle", "Stock", "ViewCount" },
                values: new object[,]
                {
                    { 1, new DateTime(2023, 4, 19, 23, 39, 25, 378, DateTimeKind.Local).AddTicks(6362), "Áo Sơ Mi Trắng Nam", "Áo Sơ Mi Trắng Nam", "Áo Sơ Mi Trắng Nam", 900000m, 1000000m, "ao-so-mi-trang-nam", "Áo Sơ Mi Trắng Nam", "Áo Sơ Mi Trắng Nam", 0, 0 },
                    { 2, new DateTime(2023, 4, 19, 23, 39, 25, 378, DateTimeKind.Local).AddTicks(6374), "Áo Sơ Mi Trắng Nữ", "Áo Sơ Mi Trắng Nữ", "Áo Sơ Mi Trắng Nữ", 900000m, 1000000m, "ao-so-mi-trang-nu", "Áo Sơ Mi Trắng Nữ", "Áo Sơ Mi Trắng Nữ", 0, 0 }
                });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "ConcurrencyStamp", "Description", "Name", "NormalizedName" },
                values: new object[] { new Guid("9b6fc39c-753f-460e-99a6-99bbd80ee262"), "c0f8bf05-94df-4004-99ad-ab9f6f6964f9", "Administrator role", "admin", "admin" });
